...
# Database: HealthTrak
# Generation Time: 2012-11-25 23:49:18 +0000
# ************************************************************
...
CREATE TABLE `Billing` (
  ...
  `DateFirstInvoice` bigint(30) NOT NULL,
  `DateLastInvoice` varchar(1000) NOT NULL,
  `DatePaid` bigint(30) NOT NULL,
  PRIMARY KEY (`ID`),
...
CREATE TABLE `Employee` (
  ...
  `ChangeDate` bigint(30) DEFAULT NULL,
  PRIMARY KEY (`ID`),
...
CREATE TABLE `Patient` (
  ...
  `DateOfBirth` bigint(30) NOT NULL,
...
VALUES
	(1,'Jamies','Hagget','Marcie','123 SDSU Way, San Diego, CA','6197508086',NULL,1075190400000,1,'Kendrick Stirgus',NULL,NULL,6,1353886311),
	(2,'Tyler','','Moskovic','123 UCSD Way, San Diego, CA','6666666666',NULL,794131200000,0,'sldjnf',NULL,NULL,1,2012),
	(3,'Lonnie','Luczynski',NULL,'123 BeneTrac Way, San Diego, CA','7777777777',NULL,794131200000,1,'',NULL,NULL,1,2012),
	(4,'Ted','McAllen','Douglas','123 Tijuana Way, San Diego, CA','8888888888',NULL,794131200000,1,'Dr. Frankenstein',NULL,NULL,1,2012),
	(5,'Tameka','Wasmund',NULL,'123 Chula Vista Way, San Diego, CA','9999999999',NULL,794131200000,1,'Dr. Bley',NULL,NULL,1,2012),
	(6,'Carola','Saka','y','345 Jamacha rd APT #6,Ca,92020','6195743323',0,794131200000,0,'Max soon',NULL,NULL,2,2012),
	(7,'Adam','Koona','r','225 Grove rd APT #6,Ca,92320','61943232',1,794131200000,1,'John moon',NULL,NULL,2,2012),
	(8,'John','noor','j','322 Jamacha rd APT #6,Ca,92020','6197764345',0,794131200000,0,'jack box',NULL,NULL,2,2012),
	(9,'Madlen','kaza','y','278 Rancho,Ca,92019','6195743323',0,794131200000,1,'Noon Soon',NULL,NULL,2,2012),
	(10,'Sona','Rahema','D','67 Jamacha rd APT #10,Ca,92020','6195743323',0,794131200000,0,'Nawal jon',NULL,NULL,2,2012);
...
INSERT INTO `PatientHistory` (`HistoryID`, `PatientID`, `NameFirst`, `NameLast`, `NameMiddle`, `Address`, `Phone`, `InsuranceCarrierID`, `DateOfBirth`, `Gender`, `PrimaryCarePhysician`, `MedicationListID`, `AppointmentsID`, `ChangeByID`, `ChangeDate`)
VALUES
	(18,1,'Jamie','Hagget','Marcie','123 SDSU Way, San Diego, CA','6197508086',NULL,1075190400000,1,'',NULL,NULL,6,1353886001000),
	(20,1,'Jamie','Hagget','Marcie','123 SDSU Way, San Diego, CA','6197508086',NULL,1075190400000,1,'',NULL,NULL,6,1353886315000),
	(21,1,'Jamies','Hagget','Marcie','123 SDSU Way, San Diego, CA','6197508086',NULL,1075190400000,1,'',NULL,NULL,6,1353887078000),
	(22,1,'Jamies','Hagget','Marcie','123 SDSU Way, San Diego, CA','6197508086',NULL,1075190400000,1,'Hal Werblow',NULL,NULL,6,1353887089000);
...
CREATE TABLE `PatientMedication` (
  ...
  `PatientID` int(11) NOT NULL,
  `MedicationId` int(11) NOT NULL,
  `DataPrescribed` bigint(30) NOT NULL,
  `PrescribedByID` int(11) NOT NULL,
  `ChangedByID` int(11) NOT NULL,
  `ChangeDate` bigint(30) NOT NULL,
  `PatientEncounterID` int(11) NOT NULL,
  `DateEnd` bigint(30) NOT NULL,
  `EmployeeID` int(11) NOT NULL,
  `Dosage` int(200) NOT NULL,
  `Frequency` int(11) NOT NULL,
  `LastFiledDate` bigint(30) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `PatientID` (`PatientID`),
  KEY `MedicationId` (`MedicationId`),
  KEY `EmployeeID` (`EmployeeID`),
...
INSERT INTO `User` (`ID`, `UserName`, `JobTitle`, `Password`, `UserTypeID`, `EmployeeNumber`, `ChangeByID`)
VALUES
	(1,'fausto','Administrator','pnPqZhA3bgIqxZFR5MIF8aZfxhOCuVlABgNjKpuCWdM=',7,'1',34),
	(2,'julian','Administrator','123',7,'12',1),
	(3,'test_cheifofmedicine','Cheif Of Medicine','5f4dcc3b5aa765d61d8327deb882cf99',1,'14',1),
	(6,'test_physician','Doctor','5f4dcc3b5aa765d61d8327deb882cf99',2,NULL,0),
	(7,'test_nurse','Nurse','5f4dcc3b5aa765d61d8327deb882cf99',3,NULL,0),
	(8,'test_pharmacist','Pharmacist','5f4dcc3b5aa765d61d8327deb882cf99',4,NULL,0),
	(9,'test_pharmacistassistant','Pharmacist\'s Assistant','5f4dcc3b5aa765d61d8327deb882cf99',5,NULL,0),
	(11,'test_humanresources','Human Resources','5f4dcc3b5aa765d61d8327deb882cf99',6,NULL,0);
